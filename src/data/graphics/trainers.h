...
const u32 gTrainerFrontPic_TeamRocketMale[] = INCBIN_U32("graphics/trainers/front_pics/team_rocket_male.4bpp.lz");
const u32 gTrainerPalette_TeamRocketMale[] = INCBIN_U32("graphics/trainers/front_pics/team_rocket_male.gbapal.lz");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TEAM_ROCKET_MALE, TeamRocketMale),
};
